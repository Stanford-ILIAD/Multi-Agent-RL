...
def main():
    ...
    env = MAWaterWorldTeams(fh.train_args['n_pursuers1'],
                        fh.train_args['n_pursuers2'],
                       fh.train_args['n_evaders1'],
                       fh.train_args['n_evaders2'],
                       ...
                       collision_penalty=fh.train_args['collision_penalty'],
                       reward_mech='local',
