...
from madrl_environments.pursuit import MAWaterWorldTeams
...
def main(parser):
    mode = parser._mode
    args = parser.args
    env = MAWaterWorldTeams(args.n_pursuers1, args.n_pursuers2, args.n_evaders1, args.n_evaders2, args.n_coop, args.n_poison,
                       radius=args.radius, n_sensors=args.n_sensors, food_reward=args.food_reward,
                       poison_reward=args.poison_reward, collision_penalty= args.collision_penalty, encounter_reward=args.encounter_reward,
